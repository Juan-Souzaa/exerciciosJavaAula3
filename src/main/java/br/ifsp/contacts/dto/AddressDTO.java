...
public class AddressDTO {
    ...
    public AddressDTO(Long id, String rua, String cidade, String estado, String cep) {
        this.id = id;
        this.rua = rua;
        this.cidade = cidade;
        this.estado = estado;
    ...
    public AddressDTO(Long id, String rua, String cidade, String estado, String cep, ContactDTO contact) {
        this.id = id;
        this.rua = rua;
        this.cidade = cidade;
        this.estado = estado;
